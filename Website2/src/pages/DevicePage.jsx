...
const DevicePage = ({ isDark, scrollbarStyles, onBack }) => {
  ...
  return (
    <div ref={containerRef} onScroll={handleScroll} className={`h-screen overflow-y-auto scroll-smooth font-sans selection:bg-purple-500/30 transition-colors duration-500 ${isDark ? 'bg-black text-white' : 'bg-[#fdfdfd] text-slate-900'} ${scrollbarStyles}`}>
      ...
      {/* Hero */}
      <section className="relative flex flex-col items-center pt-14 sm:pt-20 pb-16 md:pb-24 overflow-hidden">
      ...
      {/* Anatomia */}
      <section className={`py-16 md:py-24 border-b transition-colors duration-500 ${isDark ? 'bg-black border-white/5' : 'bg-[#fdfdfd] border-gray-200'}`}>
        <div className="max-w-7xl mx-auto px-6 w-full">
      ...
      {/* Galeria */}
      <section className={`py-16 md:py-24 border-y transition-colors duration-500 ${isDark ? 'bg-[#030303] border-white/5' : 'bg-[#fafafa] border-gray-200'}`} id="galeria">
        <div className="max-w-7xl mx-auto px-6 w-full">
